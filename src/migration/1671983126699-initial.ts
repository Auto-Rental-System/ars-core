...
export class initial1671983126699 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "user_identity" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP DEFAULT now(), "email" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, CONSTRAINT "UQ_7ad44f9fcbfc95e0a8436bbb029" UNIQUE ("email"), CONSTRAINT "PK_87b5856b206b5b77e6e2fa29508" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`ALTER TABLE "user" ADD CONSTRAINT "FK_dee2c7a36ac4ca095ef46f64c3d" FOREIGN KEY ("user_identity_id") REFERENCES "user_identity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
	}
