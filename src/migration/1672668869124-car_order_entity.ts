...
export class carOrderEntity1672668869124 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rental_order" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "start_at" TIMESTAMP NOT NULL, "end_at" TIMESTAMP NOT NULL, "user_id" integer NOT NULL, "car_id" integer NOT NULL, CONSTRAINT "PK_5e10148050c41741832adf4f147" PRIMARY KEY ("id"))`);
